...
export declare const IpcChannels: {
    readonly validatePackage: "flowforge:validate-package";
    readonly loadPackage: "flowforge:load-package";
    readonly startRun: "flowforge:start-run";
    readonly resumeRun: "flowforge:resume-run";
    readonly getRun: "flowforge:get-run";
    readonly getAuditTrail: "flowforge:get-audit-trail";
    readonly signIn: "flowforge:sign-in";
    readonly signOut: "flowforge:sign-out";
    readonly getCurrentUser: "flowforge:get-current-user";
};
export type { AgentSummary, AuditTrailSnapshot, HumanResponse, PackageSummary, PackageValidationResult, PendingTaskSnapshot, RunSnapshot, UserSnapshot, WorkflowSummary } from '@flowforge/kernel';
/**
 ...
 */
import type { AuditTrailSnapshot, HumanResponse, PackageSummary, PackageValidationResult, RunSnapshot, UserSnapshot } from '@flowforge/kernel';
