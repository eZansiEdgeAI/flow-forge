...
export type WorkflowNodeType = 'agent' | 'humanApproval' | 'humanInput' | 'branch' | 'parallel' | 'end';
...
export type WorkflowNode = AgentNode | HumanApprovalNode | HumanInputNode | BranchNode | ParallelNode | EndNode;
...
export type Permission = 'workflow.start' | 'workflow.input' | 'workflow.approve' | 'audit.view' | 'package.manage';
...
export declare function principalActor(principal: Principal): AuditActor;
